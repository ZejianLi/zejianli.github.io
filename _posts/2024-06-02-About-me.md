...
- Training and Distillation of Flow Matching Models
- Post-Trainging Image/3D generation
- Evaluation of Generative Content
- Interative Human-AI Application
...
I am now mostly in Ningbo but somtime I will go back to Zijingang Campus in Hangzhou. I am looking for self-motivated PhD, master and undergraduate students to join my research group! I am also looking for postdoc and research assistant. Exchange or visiting students are also welcome. If you are interested in generative models, Human-AI cocreation and want to join us, please send me your CV to zejianlee at zju.edu.cn. For those who are pursuing master degrees, notice that right now I only have master quota of industrial design engineering, but not software engineering or artificial intelligence. However, the student's research direction is formed based on his or her capacity and interest.

我base在宁波，偶然回到杭州紫金港。团队招收博士生、硕士生和对科研感兴趣的本科生，以及博士后和科研助理，也欢迎不同学校的同学们过来访问交换（我会帮助申请住宿）。团队主要学术论文请看[publication部分](https://zejianli.github.io/markdown/2024/06/02/About-me.html#h-selected-publications-部分发表内容)。代表性科艺融合作品包括[人工智能发展简史图谱](https://mp.weixin.qq.com/s/pwXEE0lUFsIGirGT_IXBsg)、[《运河·生长·万象》系列作品](https://mp.weixin.qq.com/s/_NjjqPFc5HAMMSyikLwF8g)、[“墨染”系列国画创作系统](http://www.idi.zju.edu.cn/project/2804.html)。代表性课程是[人工智能大模型前沿与应用](https://www.xueyinonline.com/detail/250928740)（通识课程），[智能设计](https://mp.weixin.qq.com/s/KCXVSui02Q_W3fRVLDnInA)（研究生课程）和智能设计基础（本科生课程）。如果你对生成模型、人机协同创作的研究感兴趣，有意向加入我们团队，欢迎发邮件到zejianlee at zju.edu.cn，请附个人简历。因为我隶属设计学科，硕士名额大部分只有“工业设计工程”专业，（我也有人工智能、软件工程的导师资格，但名额基本分不到呜呜呜）。如果联系读硕士研究生，请说明是否接受工业设计工程的名额。团队内往届工业设计工程专业的硕士生，技术背景的小同学从事生成算法研究，设计背景的小同学从事人机交互方向研究，组内相互合作搞点大招。我具有电子信息的专业博士导师资格，但每年名额不确定，团队已有博士生，会lead硕士生开展研究。


## Selected Publications 部分发表内容


- Mean Flow Distillation: Robust and Stable Distillation for Flow Matching Models.<br>
An Zhao, Shengyuan Zhang, Zhongjian Sun, Yixiang Zhou, **Zejian Li\***, Ling Yang, Tianrun Chen, Lingyun Sun. <br>
Accepted by Interaction Conference on Machine Learning 2026. 首次实现完全基于流匹配理论的流匹配模型蒸馏算法，应用于文生图、自动驾驶4D动态场景生成等。

- SCoRE: Standardized Human Evaluation Provides a Reliable Measure for Semantic Consistency of Text-to-Image Generation. <br>
Zejian Li, Qi Liu, Jiaman Pan, Rui Huang, Lefan Hou, Xiangfei Hu, Jiarui Ma, Shengyuan Zhang, Jiesi Zhang, Xuetao Tian, Yun Lu, Hao Jiang, Ling Yang, Xiaoming Deng.<br>
Accepted by IJCV2026, https://link.springer.com/article/10.1007/s11263-026-02842-y 首个标准化文生图一致性人类评估量表，量表构建过程遵循心理测量学相关理论，具备鲁棒性。

- From Traditional Craft to Digital Restoration: An Intelligent Rebirth of Ancient Chinese Painting Restoration Technique. <br>
Ying Zhang, Kewen Zhu, **Zejian Li\***, Zhongni Liu, Kaixin Jia, Jiesi Zhang, Lingyun Sun. <br>
Humanities and Social Sciences Communications 2026, https://www.nature.com/articles/s41599-026-07117-y 生成式AI赋能新手修复师的古画修复工作。

- Circular-DPO: Aligning Multi-Stage 3D Generative Models via Preference
Feedback Loop.<br>
**Zejian Li**, Jiarui Ma, Han Xu, Weiting Zheng, Yangrui Zhu, Chenye Meng, Pei Chen, Ling Yang, Zhiyuan Yang, Changyuan Yang, Guang Yang, Immanuel Koh, Lingyun Sun.<br>
Accepted by CVPR2026 面向3D资产多阶段生成模型的首个异策略联合强化学习算法，优于独立的异策略强化学习。

- Beyond Binary Preference: Aligning Diffusion Models to Fine-grained Criteria by Decoupling Attributes.<br>
Chenye Meng, **Zejian Li\***, Zhongni Liu, Yize Li, Changle Xie, Kaixin Jia, Ling Yang, Huanghuang Deng, Shiying Ding, Shengyuan Zhang, Jiayi Li, Lingyun Sun.<br>
https://arxiv.org/abs/2601.04300 首个基于离散非均衡优劣标签的偏好优化强化学习算法，应用于专业油画生成模型的后训练领域。

- NarrAid: Supporting Storytelling of People with Aphasia via Generative Visual Scene Displays.<br>
Xiangfei Hu, Xiuqi Zheng, Qi Liu, **Zejian Li\***, Ying Zhang, Lu Wang∗, Xipei Ren∗.<br>
Accepted by CHI EA 2026. 文生图生成式人工智能辅助脑卒中后失语症患者进行自我表达。

- 3DInkGen: Extending Traditional Ink-Painting Artistry with Generative 3D Creation for Novices.<br>
Jiesi Zhang, Ying Zhang, **Zejian Li\***, Changle Xie, Huanghuang Deng, Lingyun Sun.<br> 
Accepted by CHI 2026. 新手友好的水墨风格3D资产生成管线。

- Does Sycophancy Change Decisions? Effect of LLM Sycophancy on AI-Assisted Decision-Making.<br>
**Zejian Li**, Jiaman Pan\*, Qi Liu, Yuning Xi, Yixiang Zhou, Yike Jin, Rongjie Mao, Pei Chen.<br> 
Accepted by CHI 2026. 生成式AI的谄媚对于AI辅助决策中具备一定影响的作用。

- PoemPalette: Facilitating Poetry Creative Exploration and Understanding through the Ideorealm Alignment of Paintings and Poems.<br>
Ying Zhang, Kaixin Jia, HongJian Zhang, Kewen Zhu, Chenye Meng, Jiesi Zhang, **Zejian Li\***, Pei Chen, Lingyun Sun.<br>
Accepted by CHI 2026. 基于诗画一律的理论，生成式AI辅助新手领会诗歌内在含义。
...
Accepted by AAAI 2026. https://arxiv.org/abs/2504.11447 首个偏好优化强化学习和扩散模型蒸馏的统一框架，用于激光雷达系数点云补全和文生图。
...
Accepted by ACM Multimedia 2025. 克服扩散模型偏好优化强化学习的近似不准确问题。
...
Accepted by ACM Multimedia 2025. 多物体可控的场景图像生成。
...
CAAD Futures 2025. Best paper award. 图神经网络用于建筑物布局生成。
